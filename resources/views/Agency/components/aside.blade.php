<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $active == 'skillsrequirement' ? 'active' : '' }}"
                    href="{{ route('skillsrequirement') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Skills Requirement</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                ...
                <ul id="agency-nav" style="list-style: none"
                    class="nav-content collapse {{ in_array($active, ['submittedapps', 'sascompleted', 'screenedapplicants', 'approvedapplications']) ? 'show' : '' }}"
