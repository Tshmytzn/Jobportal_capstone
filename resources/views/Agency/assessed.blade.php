...
@include('Agency.components.head', ['title' => 'Skill Assessment'])

<body class="g-sidenav-show  bg-gray-100">

    @include('Agency.components.aside', ['active' => 'agencyskillassess'])

    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        @include(
            'Agency.components.navbar',
            ['headtitle' => 'Skill Assessment'],
            ['pagetitle' => 'Agency']
        )
        <!-- End Navbar -->
    ...
    @include('Agency.components.modals.skillassessmentmodals')
    @include('Agency.components.skillassessmentscripts')
</body>
